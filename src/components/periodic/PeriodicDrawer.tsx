    ...
    >
      <button
        ...
        className={clsx(
          ...
          "focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-black/35",
        )}
      >
        <span className="rounded-md bg-white px-2.5 py-1 text-[11px] font-black uppercase tracking-[0.16em] text-black shadow-sm ring-1 ring-black/10">
          Periodic table
        </span>
        <span className="flex items-center gap-2">
          ...
          <span className="flex h-7 w-7 items-center justify-center rounded-md bg-white font-display text-lg font-black leading-none text-black shadow-sm ring-1 ring-black/10">
            {isOpen ? "v" : "^"}
          </span>
        </span>
      </button>
